...
!(function (e, t, n) {
  ...
  function c(e, t, n) {
    ...
    for (var i in e)
      if (e[i] in t)
        return n === !1
          ? e[i]
          : ((o = t[e[i]]), r(o, 'function') ? u(o, n || t) : o);
    return !1;
  }
  function f() {
    var e = t.body;
  ...
  function g(e, t, o, a) {
    ...
    for (
      ...
      (f = !0), (j.modElem = s(v.shift())), (j.style = j.modElem.style);
  ...
  var x = t.documentElement,
    b = 'Moz O ms Webkit',
    _ = E._config.usePrefixes ? b.toLowerCase().split(' ') : [];
  E._domPrefixes = _;
  var w = 'svg' === x.nodeName.toLowerCase();
  w ||
    !(function (e, t) {
      function n(e, t) {
  ...
  E.atRule = T;
  var z = E._config.usePrefixes
    ? ' -webkit- -moz- -o- -ms- '.split(' ')
    : ['', ''];
  E._prefixes = z;
  var P = ((E.testStyles = d), { elem: s('modernizr') });
  ...
  var k =
    ...
    F = 'supportsCSS' in e;
  Modernizr.addTest('supports', k || F),
